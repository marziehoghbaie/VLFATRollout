...
class Multiclass_ds(Dataset):
    ...
    def __init__(self, annotation_path,
                 ...
                 image_size=256,
                 categories=["healthy", "iamd", "namd", "ga"],
                 model_type='ViViT',
                 gray_scale=True,
                 logger=None,
                 n_frames=20):
    ...
    def __getitem__(self, idx):
        ...
        imgs = transform_custom(imgs, self.image_size, gray_scale=self.gray_scale)
        # label
        _label = sample['label_int']
